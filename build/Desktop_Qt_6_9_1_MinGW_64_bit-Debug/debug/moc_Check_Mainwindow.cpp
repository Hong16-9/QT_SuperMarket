...
template <> constexpr inline auto Check_Mainwindow::qt_create_metaobjectdata<qt_meta_tag_ZN16Check_MainwindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "Check_Mainwindow",
        "on_chooselistWidget_itemDoubleClicked",
        "",
        "QListWidgetItem*",
        "item"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'on_chooselistWidget_itemDoubleClicked'
...
void Check_Mainwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_chooselistWidget_itemDoubleClicked((*reinterpret_cast< std::add_pointer_t<QListWidgetItem*>>(_a[1]))); break;
        default: ;
        }
    }
}
